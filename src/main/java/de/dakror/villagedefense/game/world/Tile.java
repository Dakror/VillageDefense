...
public class Tile {
    ...
    // -- Tile List -- //
    public static Tile empty = new Tile(0, "Empty", "empty.png", 0);
    public static Tile grass = new Tile(1, "Grass", "grass.png", 100);
    public static Tile ground = new Tile(2, "Ground", "ground.png", 100);
