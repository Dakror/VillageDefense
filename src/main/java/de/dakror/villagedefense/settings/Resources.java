...
public class Resources {
    public enum Resource {
        ...
        PEOPLE("Villager", 0, 0, 0, false),
        WOOD("Wood", 3, 0, 4, true),
        PLANKS("Planks", 2, 0, 6, true),
        STONE("Stone", 1, 1, 2, true),
        COAL("Coal", 3, 1, WOOD.getGoldValue() * 2, true),
        IRONORE("Iron ore", 0, 1, 3, true),
        // GOLDORE("Golderz", 2, 1, 4, true),
        IRONINGOT("Iron", 0, 2, Math.round((COAL.getGoldValue() * 3 + IRONORE.getGoldValue() * 4) * 0.75f), true),
        // GOLDINGOT("Gold", 1, 2, 8, true),
        WHEAT("Wheat", 0, 3, 5, true),
        FLOUR("Flour", 1, 3, 7, true),
        BREAD("Bread", 2, 3, 2 * COAL.getGoldValue() + 3 * FLOUR.getGoldValue() + 4, true),
